...
1. **Mandatory Disclosure**: AI Contributions **MUST** be disclosed. The agent
   ...
   **and** _which_ AI agent or agents were used (e.g., jules/gemini 3, claud 4,
   etc). This does not apply to the gemini code review agent, which should be
   presumed to always apply to every commit. 
3. **Forbidden Tools**: The following AI tools are forbidden for _any_ use in
...
4. **Principal Authorship**: A human (_you_) **MUST** be listed as the primary
   author or coauthor.
...
7. **Quality Standards**: AI Agents output is held to extremely strict quality
...
8. **Isolation of Concerns**:
   ...
   - Agent contributions **SHOULD NOT** mix code quality changes with functional
     changes.
9. **Branch Naming and Grouping**: Agent contributions **SHOULD** as a best
   ...
   best you can.
10. **Security and Privacy**: You **MUST NOT** include credentials,
